...
traindataset = datasets.CIFAR10('./data/dummy', train=True, download=True,transform=transform_general) # this is for balance
...
train_loader = torch.utils.data.DataLoader(traindataset, batch_size=60, shuffle=False, num_workers=0,drop_last=False)
...
bestacc = 0.0
best_accuracy = 0
ITERATION = 1 # number of cycles of pruning that should be done.
