...
class ImbalanceCIFAR10(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, root, imb_type='manual', imb_factor=0.5, rand_number=42, train=True,
                 transform=None, target_transform=None, download=False, manual_class=[0]):
...
traindataset = ImbalanceCIFAR10('./data/imbalance_new',train=True, download=True, transform=transform_general)  # this is for imbalance
testdataset = datasets.CIFAR10('./data/new', download=True, train=False, transform=transform_general)
...
bestacc = 0.0
best_accuracy = 0
ITERATION = 14 # number of cycles of pruning that should be done.
